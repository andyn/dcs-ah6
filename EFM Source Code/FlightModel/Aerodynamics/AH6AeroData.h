...
static double _ZwData[12]  = {-0.6323, -0.5453, -0.4344, -0.3404, -0.4337, -0.5473, -0.6299, -0.7150, -0.7655, -0.7977, -0.8050, -0.8096 };		// downward speed affect on force down
...
static double _ZdcData[12] = {-0.9085, -0.8591, -0.8618, -0.8912, -0.8484, -0.8853, -0.9169, -1.006, -1.105, -1.149, -1.164, -1.178 };			// collective input affect on force down (most important value for overall lift)
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
static double _MuData[12]  = { 0.0459,  0.0514,  0.0502,  0.0414, 0.0511, 0.048, 0.0406, 0.0317, 0.030, 0.027, 0.025, 0.024 };					// forward speed affect on pitch
...
static double _NdcData[12] = { 0.0125,  0.0210,  0.0284,  0.1713, 0.0224, 0.0150, 0.0125, 0.0102, 0.0100, 0.0100, 0.0110, 0.0204 };				// collective input affect on yaw
